...
public class ReadExcelDataProvider {
	...
	//Locators
	private By byEmail = By.className("login-email");
	private By byPassword = By.className("login-password");
	private By bySubmit = By.id("login-submit");
	private By byError = By.id("global-alert-queue");
	
	@BeforeClass
	public void testSetup() {
		 String driverPath = "C:\\Users\\megha\\Desktop\\SeleniumJarFiles\\chromedriver_win32\\";
	...
	public Object[][] loginData() {
		Object[][] arrayObject = getExcelData("C:/Users/megha/Desktop/SeleniumJarFiles/sanjay1.xls","Sheet1");
		return arrayObject;
	}
